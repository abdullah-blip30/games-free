...
export const GAMES_DATA: Game[] = [
  {
    ...
    category: 'Puzzle',
    description: 'Join the numbers and get to the 2048 tile! A legendary puzzle game of strategy and math.',
    rating: 4.8
  },
  {
    id: 'hextris',
    ...
    category: 'Arcade',
    description: 'Fast-paced puzzle game where you rotate a hexagon to catch falling blocks of matching colors.',
    rating: 4.5
  },
  {
    id: 'slope',
    title: 'Slope Run',
    thumbnail: 'https://images.unsplash.com/photo-1616110129282-20076a0a09e0?w=400&h=300&fit=crop',
    iframeUrl: 'https://slopegame.online/',
    category: 'Action',
    description: 'Drive a ball down a steep slope, avoiding obstacles and staying on the track in this neon-lit runner.',
    rating: 4.9
  },
  {
    id: 'paper-io',
